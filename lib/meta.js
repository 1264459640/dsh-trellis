...
function configShape() {
  return {
    ...
    /**
     * Read-only planning enforcement: when a task is in the planning phase,
     * prune generic write/edit tools from the model's tool surface, leaving
     * read tools plus trellis_artifact_update as the only write channel.
     */
    enforceReadonlyPlanning: z.boolean().default(false),
  }
}
