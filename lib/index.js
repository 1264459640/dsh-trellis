...
import { applyReadonlyPolicy, applyReadonlySections } from './readonly.js'
...
export default {
  ...
  apply(ctx, config) {
    ...
    // pruned. Gated by the enforceReadonlyPlanning master switch.
    ctx.on('system-prompt/assemble', async (assembly, context, next) => {
      ...
      const sections = applyReadonlySections(assembled.sections, st.phase, st.skipState)
      if (tools || sections) {
        return {
          ...assembled,
          ...(tools ? { tools } : {}),
