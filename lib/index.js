  ...
  apply(ctx, config) {
    ...
    const updateTool = defineTool({
      ...
      parameters: {
        ...
        force: { type: 'boolean', description: 'Optional bypass flag for git cleanliness checks when completing the task.' },
        cwd: { type: 'string', description: 'Optional absolute project dir. Defaults to the calling session cwd.' },
      },
      output: {
        schema: {
    ...
    const archiveTool = defineTool({
      ...
      parameters: {
        ...
        modified_files: { type: 'array', items: { type: 'string' }, description: 'Optional list of modified files for this task.' },
        force: { type: 'boolean', description: 'Optional bypass flag for git cleanliness checks when archiving.' },
        cwd: { type: 'string', description: 'Optional absolute project dir. Defaults to the calling session cwd.' },
      },
      output: {
        schema: {
