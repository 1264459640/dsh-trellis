      ...
      parameters: {
        ...
        step: {
          ...
          properties: {
            ...
            verified: { type: 'boolean', description: 'Mark the step verification as passed (true) when verify is required.' },
            verificationNotes: { type: 'string', description: 'Verification evidence (test cases / logs).' },
          },
          description: 'Optional incremental update to a single step. A step with verify: true cannot reach completed until verified: true is recorded via a prior call.',
        },
