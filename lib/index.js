...
export default {
  ...
  apply(ctx, config) {
    ...
    // allowlist, prune the tool surface by AUTHORIZATION state (lib/readonly.js):
    //   undecided (no task, not skipped) → read + create + skip
    //   planning (task in planning)       → read + update + artifact
    //   authorized (approved / skipped)   → full write access
